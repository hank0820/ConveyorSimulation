import type { Tray, ConveyorSegmentConfig, SimulationStateWithProgress, SourceConfig, SourceId, MergeState, OperatingSettings, SourceState, SrsTargets, TPurgeSettings } from './types'
...
export class SimulationEngine {
  ...
  startScenario(settings: OperatingSettings, planningCadenceSec: number, targets?: SrsTargets, sourceReleaseWindowSec?: number, tPurgeSettings?: TPurgeSettings) {
    if (!this.milestone7) throw new Error('Scenario startup requires the Milestone 7+ topology')
    this.milestone7.startScenario(settings, planningCadenceSec, targets, sourceReleaseWindowSec, tPurgeSettings)
  }
  ...
  getState(): SimulationStateWithProgress {
    ...
    return {
      ...
      srsControl: {
        ...
        tBypassBatch: { active: false, recordKind: 'NONE', consecutiveDownstreamBackupDepth: 0, dEntranceBlocked: false, triggerQualifies: false, authorizedTrayIds: [], enteredCount: 0, remainingCount: 0, configuredQuantity: 6, authorizedCount: 0, phase: null, batchId: null, enteredXCount: 0, exitedXCount: 0, downstreamRemainingCount: 0, purgeStarvedBehindE: false, purgeEPriorityDeferralCount: 0, authorizedAtSec: null, completedAtSec: null, inFlightBatchIds: [], completedBatchCount: 0 },
      },
      returnSystem: {
        enabled: false,
        ...
        inFlightPurgeBatches: [],
        completedPurgeBatches: [],
      ...
      sourceGrantCursor: this.mergeState.nextPriority,
      activeSourceGrant: null,
      lastCompletedSourceGrant: null,
